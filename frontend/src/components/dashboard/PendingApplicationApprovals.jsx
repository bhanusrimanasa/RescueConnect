    ...
    <div className="space-y-6">
      <div>
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">
          Adoption Applications Awaiting Final Approval
        </h2>

        <p className="text-slate-400 text-xs sm:text-sm mt-0.5">
          These applications have already been reviewed and recommended by a volunteer.
        </p>
      </div>
      ...
      {applications.length === 0 ? (
        <div className="bg-white rounded-2xl border border-slate-200/80 p-12 text-center text-slate-400 text-xs sm:text-sm shadow-sm">
          No volunteer-approved applications awaiting final decision.
        </div>
      ) : (
        <div className="space-y-6">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between gap-6">
                  ...
                  <div className="flex-1 space-y-5">
                    ...
                    <div className="bg-slate-50/70 border border-slate-100 rounded-xl p-4 text-xs sm:text-sm text-slate-600 space-y-1.5">
                      ...
                      {app.volunteerReviewedBy?.name && (
                        <p className="flex items-center gap-1.5 pt-1 border-t border-slate-200/60">
                          <span className="text-slate-400">🛡️</span>
                          <span>Volunteer Reviewer: <strong className="text-slate-800">{app.volunteerReviewedBy.name}</strong></span>
                        </p>
                      )}
                    </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto border border-slate-100">
            ...
            <div className="p-6 sm:p-8 space-y-6">
              ...
              {selectedApplication.volunteerReviewedBy?.name && (
                <div className="bg-slate-50/70 border border-slate-100 rounded-xl p-3.5 text-xs sm:text-sm">
                  ...
                  <p className="font-semibold text-slate-800 mt-1">{selectedApplication.volunteerReviewedBy.name}</p>
                </div>
              )}
